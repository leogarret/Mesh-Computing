#ifndef MC_CG_OBJ_IMPORTER_H
#define MC_CG_OBJ_IMPORTER_H
...
namespace SMeshLib {
	namespace IO {
		...
		template<class HDS>
		class Mesh : public CGAL::Modifier_base<HDS>
		{
		public:
		...
		void importOBJ(TPoly* polyhedron, char *fileName)
		{
			if (polyhedron)
			{
				try
				{
					...
					Mesh<TPoly::HalfedgeDS> _buildPolyhedron(fileName);
